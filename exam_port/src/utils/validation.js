/**
 * Comprehensive Validation Utility Library for React Native
 * Provides reusable validation functions for the mobile application
 */
...
// Reason validation for unavailability
export const validateReason = (reason, required = true) => {
  if (!reason && !required) {
    return { isValid: true, message: "" };
  }
  ...
  if (trimmedReason.length > 500) {
    return { isValid: false, message: "Reason is too long (maximum 500 characters)" };
  }
